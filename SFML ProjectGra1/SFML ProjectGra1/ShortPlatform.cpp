...
void ShortPlatform::Effect(Entity * collider, int num)
{
	if (num == 1)
	{
...
ShortPlatform::ShortPlatform(float x, float y) :GameObject(x, y)
{
	if (!Tex.loadFromFile("Textures/shortground.png"))
